...
package myfirstproject.master_job_sa_0_1;
...
/**
 * Job: master_job_SA Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class master_job_SA implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "master_job_SA";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				master_job_SA.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(master_job_SA.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		myfirstproject.sa_customers_0_1.Sa_Customers childJob_tRunJob_1 = new myfirstproject.sa_customers_0_1.Sa_Customers();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_2 = null;
		...
		myfirstproject.sa_geolocation_0_1.Sa_geolocation childJob_tRunJob_2 = new myfirstproject.sa_geolocation_0_1.Sa_geolocation();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_3 = null;
		...
		myfirstproject.sa_items_0_1.Sa_items childJob_tRunJob_3 = new myfirstproject.sa_items_0_1.Sa_items();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_4 = null;
		...
		myfirstproject.sa_orders_0_1.Sa_orders childJob_tRunJob_4 = new myfirstproject.sa_orders_0_1.Sa_orders();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_5 = null;
		...
		myfirstproject.sa_payement_0_1.Sa_Payement childJob_tRunJob_5 = new myfirstproject.sa_payement_0_1.Sa_Payement();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_6 = null;
		...
		myfirstproject.sa_product_0_1.Sa_product childJob_tRunJob_6 = new myfirstproject.sa_product_0_1.Sa_product();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_7 = null;
		...
		myfirstproject.sa_review_0_1.Sa_review childJob_tRunJob_7 = new myfirstproject.sa_review_0_1.Sa_review();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_8 = null;
		...
		myfirstproject.sa_sellers_0_1.Sa_sellers childJob_tRunJob_8 = new myfirstproject.sa_sellers_0_1.Sa_sellers();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_9 = null;
		...
		myfirstproject.sa_transaction_0_1.Sa_transaction childJob_tRunJob_9 = new myfirstproject.sa_transaction_0_1.Sa_transaction();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final master_job_SA master_job_SAClass = new master_job_SA();

        int exitCode = master_job_SAClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = master_job_SA.class.getClassLoader().getResourceAsStream("myfirstproject/master_job_sa_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = master_job_SA.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : master_job_SA");
        }
...
/************************************************************************************************
 *     90087 characters generated by Talend Open Studio for Data Integration 
