...
package myfirstproject.master_job_dwh_0_1;
...
/**
 * Job: master_job_dwh Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class master_job_dwh implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "master_job_dwh";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				master_job_dwh.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(master_job_dwh.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		myfirstproject.dim_date_0_1.dim_date childJob_tRunJob_1 = new myfirstproject.dim_date_0_1.dim_date();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_4 = null;
		...
		myfirstproject.dim_vendeur_0_1.dim_vendeur childJob_tRunJob_4 = new myfirstproject.dim_vendeur_0_1.dim_vendeur();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_2 = null;
		...
		myfirstproject.dim_client_0_1.dim_client childJob_tRunJob_2 = new myfirstproject.dim_client_0_1.dim_client();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_3 = null;
		...
		myfirstproject.dim_product_0_1.dim_product childJob_tRunJob_3 = new myfirstproject.dim_product_0_1.dim_product();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_5 = null;
		...
		myfirstproject.fait_vente_0_1.fait_vente childJob_tRunJob_5 = new myfirstproject.fait_vente_0_1.fait_vente();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final master_job_dwh master_job_dwhClass = new master_job_dwh();

        int exitCode = master_job_dwhClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = master_job_dwh.class.getClassLoader().getResourceAsStream("myfirstproject/master_job_dwh_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = master_job_dwh.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : master_job_dwh");
        }
...
/************************************************************************************************
 *     65090 characters generated by Talend Open Studio for Data Integration 
 *     on the May 12, 2026 at 6:33:39 PM CEST
 ************************************************************************************************/