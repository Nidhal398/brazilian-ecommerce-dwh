...
package myfirstproject.dim_date_0_1;
...
public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
    final static byte[] commonByteArrayLock_MYFIRSTPROJECT_dim_date = new byte[0];
    static byte[] commonByteArray_MYFIRSTPROJECT_dim_date = new byte[0];
    ...
    public String loopKey;
			    ...
			    public Integer date_commande;

				public Integer getDate_commande () {
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_MYFIRSTPROJECT_dim_date) {
        	...
        	try {
        		...
        		int length = 0;
						...
						this.date_commande = readInteger(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// Integer
						...
						writeInteger(this.date_commande,dos);
...
public static class insertedStruct implements routines.system.IPersistableRow<insertedStruct> {
    final static byte[] commonByteArrayLock_MYFIRSTPROJECT_dim_date = new byte[0];
    static byte[] commonByteArray_MYFIRSTPROJECT_dim_date = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final insertedStruct other = (insertedStruct) obj;
	...
	public void copyDataTo(insertedStruct other) {
	...
	public void copyKeysDataTo(insertedStruct other) {
     ...
     * Compare keys
     */
    public int compareTo(insertedStruct other) {
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_MYFIRSTPROJECT_dim_date.length) {
				if(length < 1024 && commonByteArray_MYFIRSTPROJECT_dim_date.length == 0) {
   					commonByteArray_MYFIRSTPROJECT_dim_date = new byte[1024];
				} else {
   					commonByteArray_MYFIRSTPROJECT_dim_date = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_MYFIRSTPROJECT_dim_date, 0, length);
			strReturn = new String(commonByteArray_MYFIRSTPROJECT_dim_date, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_MYFIRSTPROJECT_dim_date, 0, length);
			strReturn = new String(commonByteArray_MYFIRSTPROJECT_dim_date, 0, length, utf8Charset);
		}
		return strReturn;
	}
...
insertedStruct inserted = new insertedStruct();
insertedStruct row2 = inserted;
...
int count_tDBOutput_1=0;
                                ...
                                try (java.sql.ResultSet rsTable_tDBOutput_1 = dbMetaData_tDBOutput_1.getTables(null, null, null, new String[]{"TABLE"})) {
                                    ...
                                    while(rsTable_tDBOutput_1.next()) {
                                        ...
                                        if(table_tDBOutput_1.equals(("dim_date"))
                                ...
                                try(java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
                                    stmtCreate_tDBOutput_1.execute("CREATE TABLE \"" + tableName_tDBOutput_1 + "\"(\"sk_date\" INT4 ,\"date_commande\" VARCHAR(255)  ,\"jour\" INT4 ,\"mois\" INT4 ,\"annee\" INT4 ,\"semestre\" INT4 ,\"semaine\" INT4 ,primary key(\"sk_date\",\"date_commande\"))");
                                }
	    String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1 + "\" (\"sk_date\",\"date_commande\",\"jour\",\"mois\",\"annee\",\"semestre\",\"semaine\") VALUES (?,?,?,?,?,?,?)";
 ...
 */
	...
	currentComponent="tLogRow_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"inserted");
					}
	...
	///////////////////////
        ...
        util_tLogRow_1.addRow(new String[]{"sk_date","date_commande","jour","mois","annee","semestre","semaine",});        
...
insertedStruct inserted_tmp = new insertedStruct();
// ###############################
...
+"ublic\".\"orders\".\"order_estimated_delivery_date\"\nFROM \"public\".\"orders\"";
        	...
        	row1.order_status = routines.system.JDBCUtil.getString(rs_tDBInput_1, 3, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 4) {
								row1.order_purchase_timestamp = null;
							} else {
	                         		
        	row1.order_purchase_timestamp = routines.system.JDBCUtil.getString(rs_tDBInput_1, 4, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 5) {
								row1.order_approved_at = null;
							} else {
	                         		
        	row1.order_approved_at = routines.system.JDBCUtil.getString(rs_tDBInput_1, 5, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 6) {
								row1.order_delivered_carrier_date = null;
							} else {
	                         		
        	row1.order_delivered_carrier_date = routines.system.JDBCUtil.getString(rs_tDBInput_1, 6, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 7) {
								row1.order_delivered_customer_date = null;
							} else {
	                         		
        	row1.order_delivered_customer_date = routines.system.JDBCUtil.getString(rs_tDBInput_1, 7, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 8) {
								row1.order_estimated_delivery_date = null;
							} else {
	                         		
        	row1.order_estimated_delivery_date = routines.system.JDBCUtil.getString(rs_tDBInput_1, 8, false);
		                    }
...
// # Output table : 'inserted'
// # Filter conditions 
if( 

row1.order_purchase_timestamp != null && !row1.order_purchase_timestamp.trim().isEmpty()

 ) {
inserted_tmp.sk_date = Numeric.sequence("s1",1,1) ;
inserted_tmp.date_commande = Integer.parseInt(
    TalendDate.formatDate(
        "yyyyMMdd", 
        TalendDate.parseDate("yyyy-MM-dd HH:mm:ss", row1.order_purchase_timestamp)
    )
) ;
inserted_tmp.jour = (Integer) TalendDate.getPartOfDate(
    "DAY_OF_MONTH",
    TalendDate.parseDate("yyyy-MM-dd HH:mm:ss", row1.order_purchase_timestamp)
) ;
inserted_tmp.mois = (Integer) TalendDate.getPartOfDate(
    "MONTH",
    TalendDate.parseDate("yyyy-MM-dd HH:mm:ss", row1.order_purchase_timestamp)
) ;
inserted_tmp.annee = (Integer) TalendDate.getPartOfDate(
    "YEAR",
    TalendDate.parseDate("yyyy-MM-dd HH:mm:ss", row1.order_purchase_timestamp)
) ;
inserted_tmp.semestre = (TalendDate.getPartOfDate(
    "MONTH",
    TalendDate.parseDate("yyyy-MM-dd HH:mm:ss", row1.order_purchase_timestamp)
) <= 6) ? 1 : 2 ;
inserted_tmp.semaine = TalendDate.getPartOfDate("WEEK_OF_YEAR", TalendDate.parseDate("yyyy-MM-dd HH:mm:ss", row1.order_purchase_timestamp)) ;
...
///////////////////////		
	    		...
	    		if(inserted.sk_date != null) { //              
                 row_tLogRow_1[0]=    						    
				                String.valueOf(inserted.sk_date)			
					          ;	
							
	    		} //			
    			   				
	    		if(inserted.date_commande != null) { //              
                 row_tLogRow_1[1]=    						    
				                String.valueOf(inserted.date_commande)			
					          ;	
							
	    		} //			
    			   				
	    		if(inserted.jour != null) { //              
                 row_tLogRow_1[2]=    						    
				                String.valueOf(inserted.jour)			
					          ;	
							
	    		} //			
    			   				
	    		if(inserted.mois != null) { //              
                 row_tLogRow_1[3]=    						    
				                String.valueOf(inserted.mois)			
					          ;	
							
	    		} //			
    			   				
	    		if(inserted.annee != null) { //              
                 row_tLogRow_1[4]=    						    
				                String.valueOf(inserted.annee)			
					          ;	
							
	    		} //			
    			   				
	    		if(inserted.semestre != null) { //              
                 row_tLogRow_1[5]=    						    
				                String.valueOf(inserted.semestre)			
					          ;	
							
	    		} //			
    			   				
	    		if(inserted.semaine != null) { //              
                 row_tLogRow_1[6]=    						    
				                String.valueOf(inserted.semaine)			
					          ;	
...
///////////////////////    			
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"inserted");
			  	}
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = dim_date.class.getClassLoader().getResourceAsStream("myfirstproject/dim_date_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     91153 characters generated by Talend Open Studio for Data Integration 
 *     on the May 13, 2026 at 3:17:48 PM CEST
 ************************************************************************************************/